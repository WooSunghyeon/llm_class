...
def parse_args():
    ...
    parser.add_argument('--peft_model_id', type=str, default='model_outputs', help='PEFT model ID to load.')
    parser.add_argument('--output_dir', type=str, default='merged_outputs', help='Directory to save the merged model.')
